<%@ Page Language="C#" CodeBehind="Edit_Ad.aspx.cs" Inherits="Edit_Ad" %>
...
<body background="back.jpg">
    ...
    <h1>Ad_id</h1>
        <asp:TextBox class="text" id="Ad_id" runat="server"/>
            <br />
    ...
    <h1>description</h1>
        ...
        <asp:TextBox class="text" id="location" runat="server"/>
          <br />
    <asp:Button class="button" ID="Edit" Text="Edit" runat="server" OnClick="Edit_Click" />
    <br />
