<%@ Page Language="C#" CodeBehind="filterCont.aspx.cs" Inherits="Staff.FilterContt" %>
...
<fieldset>
    <legend></legend>
   <h1>Choose which content you want to filter:</h1>
<asp:DropDownList ID="UploadedAt" runat="server" />
<br>
<asp:DropDownList ID="AorR" runat="server" />
 
 <br><br>
<asp:Button class="button" id="button1" runat="server" Text="Submit" OnClick="Submit" Width="154px" />
