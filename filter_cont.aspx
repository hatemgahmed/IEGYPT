<%@ Page Language="C#" CodeBehind="filter_cont.aspx.cs" Inherits="Staff.filter" %>
...
<br><br>
<asp:Button class="button" id="button1" runat="server" Text="Choose Contributer" OnClick="Choose1" Width="154px" />
